...
func (s *ProjectContract) CreateProject(ctx contractapi.TransactionContextInterface, id, name, user, org, cat, url, des string) error {
	...
	err = s.Insert(ctx,string(projectJSON))
	if err != nil {
        return err
    }
	return nil
